...
### Post 1 [score 9/10, pattern: leak-insider + conflict-drama] [X CTA] [status: draft]
...
### Post 2 [score 8/10, pattern: money-broad + numbers-broad] [status: draft]
...
### Post 3 [score 6/10, pattern: ecosystem-drama + contrarian, backup] [backup] [status: draft]
