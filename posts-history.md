...
### Post 1 [score 7/10, pattern: leak-insider + conflict-drama] [status: draft]
...
### Post 2 [score 8/10, pattern: leak-insider + conflict-drama] [X CTA] [status: draft]
...
### Post 3 [score 5/10, pattern: numbers-broad + contrarian, backup] [backup] [status: draft]
