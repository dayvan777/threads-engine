...
### Post 1 [score 8/10, pattern: money-access + conflict-drama] [X CTA] [status: draft]
...
### Post 2 [score 6/10, pattern: leak-insider + conflict-drama] [status: draft]
...
### Post 3 [score 5/10, pattern: conflict-drama + deadline, backup] [backup] [status: draft]
