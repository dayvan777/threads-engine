...
### Post 1 [score 8/10, pattern: money-broad + contrarian] [status: draft]
...
### Post 2 [score 7/10, pattern: conflict-drama + leak-insider] [X CTA] [status: draft]
...
### Post 3 [score 7/10, pattern: money-access + contrarian, backup] [backup] [status: draft]
